  ...
  return (
    ...
    >
      ...
      <p style={{ width: "80%", margin: "0 auto", paddingBottom: "150px" }}>
        ...
        cannot be returned, like perishable goods (such as food, flowers, or
        plants), custom products (such as special orders or personalised items),
        and personal care goods (such as beauty products). We also do not accept
